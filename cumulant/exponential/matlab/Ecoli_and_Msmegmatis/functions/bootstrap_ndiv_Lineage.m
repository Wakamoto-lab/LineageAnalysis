function [cerr, werr,Cerr, Werr, LwSDerr] = bootstrap_ndiv_Lineage(nBootstrap, ndivList, T_tot)
    ...
    Cerr = zeros(2,6); % list of standard deviations of 1st - 6th cumulants
    Werr = zeros(2,6); % list of standard deviaitons of 1st - 6th cumulant weights
    LwSDerr = zeros(2,5); % standard deviations of population growth rate and contribution of selection strength for population growth rate
